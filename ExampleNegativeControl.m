function [distance_nc_sort_M9V7Z1A1, distance_nc_avgMIN_M9V7Z1A1, distance_nc_avgMIN_hist_M9V7Z1A1] = ExampleNegativeControl(claudin5_full_M9V7Z1A1,coord_M9V7Z1A1)
...
%   Create the new point if it is between 1.5*scale and 4.5*scale distance
%   of fluorescent signal (claudin 5 in this case) and if it is within the
...
for i = 1 : nnn_nc % shorter, "coord_M9V7Z1A1"
    ...
    % future analyses.
    Total = 100;
    distance_nc_sort_M9V7Z1A1 = distance_nc_sort_old(1:Total, 1:N_nc); % take top 1000 values from this array 
